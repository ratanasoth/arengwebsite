        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header text-bold">
                    <i class="fa fa-align-justify"></i> New Hot News&nbsp;&nbsp;
                    ...
                    >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="text" required autofocus name="short_description" id="short_description" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-sm-8">
                                <input type="file" name="image" required id="image" accept="image/*" onchange="loadFile(event)">
                            </div>
                        </div>
                        <div class="form-group row">
